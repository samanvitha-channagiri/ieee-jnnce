// src/AnveshanaEvent.js
import React, { useState } from 'react';
import './AnveshanaEvents.css'; // Import custom styles
...
const events = [
    {
        ...
        description: "Anveshana's Pixel Puzzles event offers an immersive platform for enthusiasts todelve into the intricate world of UI/UX interface development. With a blend of creativity and technical prowess, participants are challenged to unravel the complexities of pixel-perfect design. Guided by principles of user-centered design, participants navigate through the puzzle of user interfaces, crafting seamless digital experiences that captivate and engage.",
        image: images[6]
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: "Tech Quest challenged participants to embark on a journey of exploration andlearning, providing them with an opportunity to delve into the depths of technology and expand their knowledge.",
        image: images[8]
    },
    {
        id: 4,
